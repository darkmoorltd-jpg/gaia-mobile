...
export default function CropsTab() {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        source={{ uri: 'https://images.unsplash.com/photo-1590691566903-692bf5ca7493?w=1200' }}
        style={styles.bg}
      ...
      >
        ...
        >
          <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
            <Text style={styles.kicker}>PEST DETECTION</Text>
            <Text style={styles.title}>Identify any pest</Text>
            <Text style={styles.subtitle}>Snap a photo. Get the species in seconds.</Text>
