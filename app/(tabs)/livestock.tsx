...
export default function CropsTab() {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        source={{ uri: 'https://images.unsplash.com/photo-1570042225831-d98fa7577f1e?w=1200' }}
        style={styles.bg}
      ...
      >
        ...
        >
          <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
            <Text style={styles.kicker}>LIVESTOCK HEALTH</Text>
            <Text style={styles.title}>Protect your herd</Text>
            <Text style={styles.subtitle}>Diagnose cattle and poultry diseases from a photo.</Text>
