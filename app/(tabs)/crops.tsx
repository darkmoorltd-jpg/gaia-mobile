...
export default function CropsTab() {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        source={{ uri: 'https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?w=1200' }}
        style={styles.bg}
      ...
      >
        ...
        >
          <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
            <Text style={styles.kicker}>CROP DISEASE</Text>
            <Text style={styles.title}>Protect your harvest</Text>
            <Text style={styles.subtitle}>Photograph a leaf. Get an instant diagnosis.</Text>
