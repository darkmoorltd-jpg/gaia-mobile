    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <LinearGradient colors={[palette.neonSoft, palette.surface]} style={styles.planCard}>
          ...
          <Pressable onPress={() => router.push('/buy-scans')} style={styles.planBtn}>
        ...
        <View style={styles.grid}>
          {TILES.map((t) => (
            <Pressable key={t.key} onPress={() => router.push('/(tabs)/' + t.key)} style={styles.tileOuter}>
              <ImageBackground source={{ uri: t.img }} style={styles.tile} imageStyle={{ borderRadius: 22 }}>
